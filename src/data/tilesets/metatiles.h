...
const u16 gMetatiles_PorytilesManaged_Underwater_Frlg[] = INCBIN_U16("data/tilesets/primary/underwater_frlg/porytiles_bin/metatiles.bin");
const u16 gMetatileAttributes_PorytilesManaged_Underwater_Frlg[] = INCBIN_U16("data/tilesets/primary/underwater_frlg/porytiles_bin/metatile_attributes.bin");
